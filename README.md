...
## Features
Unlike other online marketplaces or discussion forums, our bot targets Discord users who would like to buy/sell/trade amongst others within the same server. This narrows the search for sellers/buyers of specific items that may be related to their interest group. The bot streamlines sharing and filtering through listed items, making the selling experience <b>easier</b> and the search for items <b>faster</b>.
